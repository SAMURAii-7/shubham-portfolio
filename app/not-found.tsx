...
const NotFound = (props: Props) => {
    return (
        <>
            <div className="mt-[80px] flex flex-row justify-between items-center w-full max-md:flex-col-reverse">
                <div className="flex flex-col justify-center items-center max-md:mt-[30px]">
